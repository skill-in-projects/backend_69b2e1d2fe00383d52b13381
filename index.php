...
<body>
    ...
    if ($path === '/api/google/gemini') {
        ...
        $ctx = stream_context_create(['http' => ['method' => 'POST', 'header' => 'Content-Type: application/json', 'content' => '{\"contents\":[{\"parts\":[{\"text\":\"Reply with exactly: OK\"}]}]}', 'timeout' => 10]]);
    ...
    if ($path === '/api/google/places') {
        ...
        $ctx = stream_context_create(['http' => ['method' => 'POST', 'header' => "Content-Type: application/json\r\nX-Goog-Api-Key: $key\r\nX-Goog-FieldMask: places.id", 'content' => '{\"textQuery\":\"coffee\"}', 'timeout' => 10]]);
